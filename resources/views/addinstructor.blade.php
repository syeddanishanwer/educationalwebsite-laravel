...
@section('content')
    <div class="main-content">
        ...
        <div style="background: white; border-radius: 12px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            @if (session('success'))
                <div style="background-color:lightgreen; margin-bottom:10px padding: 10px">{{ session('success') }} </div>
            @endif
            <form action="{{ route('instructor.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px;">
                    ...
                    <div>
                        ...
                        <div style="margin-bottom: 20px;">
                            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Full Name
                        ...
                        <!-- Designation -->
                        <div style="margin-bottom: 20px;">
                            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Designation
                                <span style="color: #e74c3c;">*</span></label>
                        ...
                        <div style="margin-bottom: 20px;">
                            <label
                                style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Status</label>
                            <select name="status"
                    ...
                    <div>
                        <!-- Profile Image -->
                        <div style="margin-bottom: 20px;">
                            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Profile
                                Photo</label>
                            <div
                                style="border: 2px dashed #d1d5db; border-radius: 10px; padding: 25px; text-align: center; background: #fafafa;">
                ...
                <div style="margin-top: 20px; border-top: 1px solid #e5e5e5; padding-top: 25px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                        ...
                        <div>
                            <label
                                style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Facebook</label>
                        ...
                        <!-- Twitter -->
                        <div>
                            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Twitter /
                                X</label>
                        ...
                        <div>
                            <label
                                style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Instagram</label>
